---
{"tags":["network"],"dg-publish":true,"dg-draft":false,"dg-created_time":"2026-01-12","dg-updated_time":"2026-01-12","permalink":"/技術文件/Network/跨網段網路拓樸結構/","dgPassFrontmatter":true,"created":"2026-01-12","updated":"2026-01-12","dg-note-properties":{"tags":["network"]}}
---
...
詳見 [[技術文件/Network/跨網段網路拓樸結構#^9b539b\|跨網段網路拓樸結構#^9b539b]] PC A 的 Default Gateway 設定
```
L 192.168.1.254/32 is directly connected, GigabitEthernet0/0
```
